"""
Jumpy v4 improves on v4 by sampling starting_jump_distance and the score_to_speed constants and saves data about each run in preparation for later learning based improvements.
"""
